...
impl Particle {
    fn new(world: &World) -> Particle {
        ...
        let x_velocity: f64 = 0.0;
        let y_velocity: f64 = rng.gen_range(-2.0..0.0);
        let x_acceleration: f64 = 0.0;
    ...
    fn update(&mut self) {
        ...
        self.color[0] = rand::thread_rng().gen_range(0.0..1.0);
        self.color[1] = rand::thread_rng().gen_range(0.0..1.0);
        self.color[2] = rand::thread_rng().gen_range(0.0..1.0);
        // self.color[3] *= 0.995;
    }
}
